...
1. The socket cannot sent message larger than 1024(maybe more,but still not enough) Byte, so the scala of the TCP problem cannot be large. In fact, in this demo I choose a little sample with 10 cities.
